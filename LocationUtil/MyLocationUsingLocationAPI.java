...
import com.addventure.loanadda.LoginActivity;
...
public class MyLocationUsingLocationAPI extends AppCompatActivity implements ConnectionCallbacks,
    ...
    RelativeLayout rlPickLocation,rlmanualLocation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rlPickLocation = (RelativeLayout) findViewById(R.id.rlPickLocation);
        rlmanualLocation = (RelativeLayout) findViewById(R.id.rlmanualLocation);



        rlPickLocation.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        rlmanualLocation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent i=new Intent(MyLocationUsingLocationAPI.this,LoginActivity.class);
                startActivity(i);
